...
<div class="container">
	...
	<!-- 功能介绍-->
	<div class="sixteen columns">
		<p>本网站提供检索功能，能够按照专家姓名、工作单位、主题等检索专家</p>
		<br />
	</div>

	<div class="twelve columns">
		<div class="headlinesearch no-margin"><h4>检索内容</h4></div>

		<div id="contact-form">
			<form method="post" action="/SoftWare/Servlet">
				
				<div class="field">
					<input type="text" name="input" class="text" id="inputname" />
				</div>
				
				<input type="radio" name="status" value="namesearch" checked="checked" />专家姓名
				<input type="radio" name="status" value="orgsearch" />专家工作单位
				<input type="radio" name="status" value="keysearch" />主题
				
				<div class="field">
					<input type="button" id="search" value=" 开始检索"  onclick="this.form.submit()"/>
				</div>
