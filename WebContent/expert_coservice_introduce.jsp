...
<div class="container">
	...
	<!-- 16 Columns -->
	<div class="sixteen columns">
		<div class="headline no-margin"><h3>什么是多机器人协同服务？</h3></div>
		<p>对于用户问题可以同时由多个专家机器人合作解答，形成面向复杂问题的“会诊”应用。它应用人工智能技术和计算机技术，根据已存储的专家级的知识、经验等同过推理得出更好更适合的解决问题的方法</p>
	</div>
	<!-- 16 Columns End -->
