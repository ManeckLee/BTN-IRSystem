...
<div class="container">
	...
	<!-- 16 Columns -->
	<div class="sixteen columns">
		<div class="headline no-margin"><h3>什么是专家智能推荐功能？</h3></div>
		<p>用户输入一段描述所要研究的课题内容，系统自动推荐出与该研究方向可能相关的专家列表或图谱，推荐的专家应该给出推荐的依据。它是根据用户的信息需求、兴趣等，将用户感兴趣的信息、产品等推荐给用户的个性化信息推荐系统。该推荐系统通过研究用户的兴趣偏好，进行个性化计算，由系统发现用户的兴趣点，从而引导用户发现自己的信息需求。它不仅能为用户提供个性化的服务，还能和用户之间建立密切关系，让用户对推荐产生依赖。</p>
	</div>
	<!-- 16 Columns End -->
